            ...
            <div className="flex items-center flex-wrap justify-center gap-10">
              {collections?.map((collection: CollectionType) => (
                ...
                >
                  ...
                  />
                  <p className=" opacity-90 text-white text-xl pl-3 mt-2 flex flex-wrap">
                    {collection?.title}
                  </p>
                  <p className="bg-transparent border hover:shadow-md hover:border-black hover:bg-slate-400 hover:text-black border-b-slate-500 px-4 py-1 opacity-90 w-fit rounded text-gray-500 absolute bottom-3 left-[80px]">
                    Read more...
                  </p>
                </Link>
              ))}
